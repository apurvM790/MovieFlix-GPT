...
const MoviesSearch = ()=>{
    ...
    <div className="absolute -z-10">
        ...
        {movieData ? <div className="flex w-11/12 flex-wrap justify-center mx-auto">{movieData.slice(0,5).map((movie,index) => <MovieSearchCard movie={movie} key={index}/> )}</div>: <Shimmer/>}
    </div>)
}
